...
description: |
  React Server Components (RSC) architecture patterns for Next.js 14+. Server-first development,
  client component boundaries, composition patterns. Use when deciding "Server or Client Component?",
  composing components, managing interactivity. Keywords: "server component", "client component",
  "'use client'", "state", "interactivity", "composition".
---

...
description: |
  Opinionated Next.js 14+ project structure and configuration. Use when scaffolding new projects,
  setting up folder structure, or configuring tsconfig.json, eslint, prettier. Activated by keywords:
  "new project", "scaffold", "initialize", "project structure", "setup".
---

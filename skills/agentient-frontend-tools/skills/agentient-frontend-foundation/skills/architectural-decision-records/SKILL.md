...
description: |
  Architecture Decision Records (ADRs) format, templates, and best practices. Use when documenting
  technical decisions, design choices, trade-offs. Keywords: "ADR", "decision record", "architecture",
  "trade-offs", "document decision".
---

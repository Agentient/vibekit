...
description: |
  Modern Python 3.13 development patterns and syntax. Use this skill when working with Python 3.13 code, async/await patterns, modern type annotations, structural pattern matching, or when implementing concurrent operations.
  PROACTIVELY use for: async functions, match/case statements, context managers, decorators, generators, and Python 3.13-specific features.
---

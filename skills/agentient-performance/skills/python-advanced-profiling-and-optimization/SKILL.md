...
description: Advanced Python profiling and optimization techniques
version: 1.0.0
author: Agentient Labs
category: Backend
tags: [python, profiling, optimization, cProfile, py-spy, memory, performance]
activation_criteria:
  keywords:
    - python performance
    - cProfile
...
result = ""
for item in items:
    result += str(item) + ","  # O(n²) time and memory
...
⚠️ **C Extension Compatibility**: Most C extensions are NOT thread-safe without GIL

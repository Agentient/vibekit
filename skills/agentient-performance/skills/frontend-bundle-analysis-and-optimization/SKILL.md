...
description: Bundle analysis and optimization strategies for Next.js applications
version: 1.0.0
author: Agentient Labs
category: Frontend
tags: [bundle, webpack, turbopack, code-splitting, tree-shaking, optimization]
activation_criteria:
  keywords:
    - bundle size
    - webpack

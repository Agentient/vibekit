...
description: React 18+ concurrency features and advanced memoization techniques
version: 1.0.0
author: Agentient Labs
category: Frontend
tags: [react, performance, concurrency, memoization, useTransition, useMemo]
activation_criteria:
  keywords:
    - react performance
    - useTransition
...
dependencies:
  required:
    - agentient-frontend-foundation/react-hooks-fundamentals
  optional:

...
description: |
  ...
  MUST BE USED for: multi-agent systems, agent coordination, sub-agent delegation, agent-as-tool implementation, and workflow orchestration.
  Keywords: multi-agent, orchestration, agent team, sub-agent, coordinator agent, LlmAgent, WorkflowAgent, AgentTool, agent communication.
---

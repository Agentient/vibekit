...
description: |
  ...
  MUST BE USED for: model configuration, temperature settings, safety controls, streaming implementation, and Vertex AI endpoint selection.
  Keywords: gemini config, model parameters, temperature, top_p, top_k, safety settings, streaming response, generate_content, function calling.
---
